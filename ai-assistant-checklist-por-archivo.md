...
- [ ] Coordinar cámara, pantalla y detectores habilitados.
- [ ] Gestionar permisos, frecuencia y ciclo de vida.
- [ ] Limitar procesamiento para no saturar CPU o GPU.
- [ ] Emitir resultados normalizados y auditables.

### `vision/camera.py`

- [ ] Enumerar y seleccionar cámaras.
- [ ] Capturar frames con resolución y FPS configurables.
- [ ] Liberar el dispositivo ante errores o apagado.
- [ ] Informar claramente permisos o cámara ocupada.

### `vision/screen.py`

- [ ] Capturar pantalla, monitor, región o ventana.
- [ ] Soportar escalado y múltiples monitores.
- [ ] Adaptarse a restricciones de Wayland, Windows y macOS.
- [ ] Evitar persistir capturas sensibles por defecto.

### `vision/detectors/yolov8.py`

- [ ] Cargar el modelo y seleccionar dispositivo.
- [ ] Normalizar detecciones, clases, confianza y coordenadas.
- [ ] Implementar umbrales y NMS configurables.
- [ ] Probar imágenes vacías y modelos ausentes.

### `vision/detectors/clip.py`

- [ ] Cargar modelo y preprocesador compatibles.
- [ ] Generar embeddings de imagen y texto.
- [ ] Normalizar similitudes y lotes.
- [ ] Gestionar caché y memoria del dispositivo.
